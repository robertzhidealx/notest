...
const NoteEditor = () => {
  ...
  useEffect(() => {
    ...
    const handleConvert = (e) => {
      ...
      (async () => {
        await noteService.update(noteObj._id, noteObj.title, noteObj.author, blocks, {});
      });
    };
    ...
    const handleGenerateQuestions = async () => {
      ...
      console.log(genQs);
      (async () => {
        await noteService.update(noteObj._id, noteObj.title, noteObj.author, blocks, {generated: list});
      })().then((res) => {
        console.log(res);
      });
    };
